<?php
/**
 * Title: Products 6x1 grid
 * Slug: theme/products-six-x-one-grid
 * Categories: products
 */
?>
...
<!-- wp:woocommerce/product-top-rated {"columns":6,"rows":1,"contentVisibility":{"image":true,"title":true,"price":true,"rating":false,"button":true},"className":"br__s"} /--></div>
