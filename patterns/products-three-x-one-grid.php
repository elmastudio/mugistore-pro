<?php
/**
 * Title: Products 3x1 grid
 * Slug: theme/products-three-x-one-grid
 * Categories: products
 */
?>
...
<!-- wp:woocommerce/product-top-rated {"columns":3,"rows":1,"contentVisibility":{"image":true,"title":true,"price":true,"rating":false,"button":true},"className":"br__s"} /--></div>
