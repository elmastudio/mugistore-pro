<?php
/**
 * Title: Products 5x1 grid
 * Slug: theme/products-five-x-one-grid
 * Categories: products
 */
?>
...
<!-- wp:woocommerce/product-top-rated {"columns":5,"rows":1,"contentVisibility":{"image":true,"title":true,"price":true,"rating":false,"button":true},"className":"br__s"} /--></div>
