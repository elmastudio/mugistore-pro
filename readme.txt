...
Tags: blog, block-styles, e-commerce, grid-layout, one-column, two-columns, three-columns, four-columns, featured-images, full-width-template, theme-options, custom-colors, custom-menu, custom-logo, editor-style, sticky-post, translation-ready, threaded-comments, wide-blocks, full-site-editing, template-editing
...
Mugistore Theme, (C) 2022 Elmastudio Ltd.
...
Mugistore WordPress Theme bundles the following third-party resources:
